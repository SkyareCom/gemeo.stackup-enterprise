(function(){
  ...
  const boot=()=>{loadUiStandard();loadInlineLists();directoryHub();setup();finance();communications();simpleFilter();structureImport()};if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',()=>setTimeout(boot,0),{once:true});else setTimeout(boot,0);
})();
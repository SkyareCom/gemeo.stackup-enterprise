...
(async()=>{
 ...
 const now=Date.now();
 const structureA=[{type:'level',label:'NÍVEL 1',duration:1200,sb:100,bb:200,ante:200}];
 const structureB=[{type:'level',label:'NÍVEL 1',duration:900,sb:200,bb:400,ante:400}];
 const state={eventId:'event-a',tournamentName:'EVENTO A',clubId:'club-a',clubName:'CLUBE A',activeEnvironmentId:'club-a',activeEnvironmentName:'CLUBE A',activeEnvironmentType:'CLUB',prepared:true,status:'VALIDADO',tournamentStatus:'VALIDATED',gameType:'NLH',tournamentFormat:'REGULAR',seatsPerTable:9,buyin:500,buyinChips:30000,startingStack:30000,structure:structureA,
  ...
  savedTournaments:[{id:'event-a',name:'EVENTO A',status:'VALIDATED',data:{clubId:'club-a',clubName:'CLUBE A',tournamentName:'EVENTO A',gameType:'NLH',tournamentFormat:'REGULAR',seatsPerTable:9,buyin:500,buyinChips:30000,startingStack:30000,structure:structureA}},{id:'event-b',name:'EVENTO B',status:'VALIDATED',data:{clubId:'club-a',clubName:'CLUBE A',tournamentName:'EVENTO B',gameType:'PLO4',tournamentFormat:'TURBO',seatsPerTable:8,buyin:777,buyinChips:25000,startingStack:25000,structure:structureB}}],

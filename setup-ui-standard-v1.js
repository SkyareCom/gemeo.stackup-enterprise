...
@media(max-width:700px){.wrap{padding:14px!important}:root{--setup-gap:9px;--setup-section-gap:20px}.structureMenu,.cta{gap:9px!important}.editorActions{grid-template-columns:repeat(3,minmax(0,1fr))!important}.editorActions button{padding:9px 6px!important;font-size:12px!important}}

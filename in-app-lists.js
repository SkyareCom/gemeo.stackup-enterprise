(function(){
  ...
  const addStyle=()=>{
    ...
    style.textContent=`
      ...
      .stackup-select-trigger::after,[data-stackup-drawer-trigger]::after{content:'ABRIR';flex:0 0 auto;color:#8DFC3B!important;font-size:10px!important;letter-spacing:.08em!important}
      .stackup-select.open>.stackup-select-trigger,.stackup-inline-drawer.open>[data-stackup-drawer-trigger]{border-color:#8DFC3B!important;color:#FFFFFF!important}
      ...
      .stackup-select-list,[data-stackup-drawer-panel]{display:none!important;position:relative!important;inset:auto!important;z-index:auto!important;width:100%!important;max-height:320px!important;overflow:auto!important;margin:8px 0 0!important;padding:6px!important;box-sizing:border-box!important;border:1px solid #27342D!important;border-radius:9px!important;background:#060907!important;box-shadow:none!important}
      ...
      .stackup-select-option,[data-stackup-drawer-panel] button,[data-stackup-drawer-panel] [role="button"]{display:flex!important;align-items:center!important;justify-content:flex-start!important;width:100%!important;min-height:42px!important;padding:9px 10px!important;box-sizing:border-box!important;border:1px solid #27342D!important;border-radius:8px!important;background:linear-gradient(#0B100D,#060907)!important;color:#AEB8B1!important;font:600 12px 'Cantarell',Arial,sans-serif!important;text-transform:uppercase!important;text-align:left!important;box-shadow:none!important}
      ...
      dialog,.modal,.popup,.popover{font-family:'Cantarell',Arial,sans-serif}
    `;
